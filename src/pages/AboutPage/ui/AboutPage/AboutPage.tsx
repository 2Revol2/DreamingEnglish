  ...
  return (
    <div>
      <div className={"bg-secondary-background"}>
        <Container className={"max-w-4xl flex flex-col gap-2 items-center py-16"}>
      ...
      <div className={"text-lg space-y-2 leading-relaxed"}>
        <Container className={"max-w-4xl py-16 flex flex-col gap-3"}>
          ...
          <ul>
            ...
            <li className={"flex gap-1 items-center"}>
              <MdOutlineEmail />
              My email: <b>maksimbaluta02@gmail.com</b>{" "}
            </li>
          </ul>
      ...
      <div className={"bg-secondary-background"}>
        <Container className={"max-w-4xl flex flex-col gap-3 py-16 items-center"}>
