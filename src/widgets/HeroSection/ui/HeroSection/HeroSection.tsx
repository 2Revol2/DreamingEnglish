...
export const HeroSection = () => {
  return (
    <section className={"lg:pt-20 pt-10 pb-10"}>
      <Container className={"flex lg:flex-row flex-col justify-between gap-3 h-full"}>
        <div className={"flex flex-col gap-2 items-center lg:items-start"}>
          ...
          <p className="text-sm sm:text-base lg:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 text-center lg:text-start">
            Learn a new Language as if it’s your first. Through immersive content that is as engaging as it is
            effective.
          </p>
