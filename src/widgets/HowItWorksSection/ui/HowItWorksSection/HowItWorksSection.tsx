    ...
    <section className={"lg:pt-20 pt-10 lg:pb-16 pb-8 bg-secondary-background"}>
      <Container className={"flex flex-col gap-10"}>
        ...
        <p className={"text-center w-full max-w-xl mx-auto  text-muted-foreground"}>
          We all learned our first language the same way: by being immersed, listening, and improving little by little.
          Dreaming gives you the content you need to mimic this process. No memorization, no grammar drills.
        </p>
